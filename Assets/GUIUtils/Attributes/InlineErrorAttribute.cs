...
namespace Rhinox.GUIUtils.Odin
{
    ...
    public class InlineErrorAttribute : Attribute
    {
        ...
        public InlineErrorAttribute(string text, string memberName)
        {
            this.Text = text;
        ...
        public InlineErrorAttribute(string text, string memberName, object optionalValue)
        {
            this.Text = text;
            this.MemberName = memberName;
