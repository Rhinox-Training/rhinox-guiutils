...
//             GUIUtility.keyboardControl == this.id && EditorGUIUtility.HasCurrentWindowKeyFocus();
//
...
//                     {
//                         if (GUI.Button(rect1,
//                                 list.onAddDropdownCallback != null ? this.iconToolbarPlusMore : this.iconToolbarPlus,
//                                 this.preButton))
//                         {
