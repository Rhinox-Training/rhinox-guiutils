...
namespace Rhinox.GUIUtils.Editor
{
    public static partial class eUtility
    {
        ...
        public class FoldoutData
        {
            ...
            {
#if ODIN_INSPECTOR_3
                float t = GUITimeHelper.LayoutDeltaTime;
#else
                EditorTimeHelper.Time.Update();
                float t = EditorTimeHelper.Time.DeltaTime;
#endif 
                // assuming event type == EventType.Layout
                Time = Mathf.MoveTowards(Time, IsExpanded ? 1f : 0.0f, t * (1f / SirenixEditorGUI.DefaultFadeGroupDuration));
            }
